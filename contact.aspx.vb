...
Partial Class contact
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles sendBT.Click

        'Declare variables to create a new mail message and client connection.
        Dim msg As New MailMessage
        Dim client As New SmtpClient

        msg.To.Add("christopher-p-barber@uiowa.edu")  'destination email address
        msg.From = New MailAddress(senderAddress.Text)  'get the address from the textbox
        msg.Subject = "contact test"  'set the message subject line
